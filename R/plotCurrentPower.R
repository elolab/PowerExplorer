...
#' @param savePlot logical; if \code{TRUE},
#' save the plot into folder "savedPlots" in work directory.
...
#' plotCurrentPower(exampleEstimatedPower, savePlot=TRUE)
#'
# Author: Xu Qiao
# Created: 30th, Oct, 2017
# Last Modifed: 2nd, Jan, 2018
plotCurrentPower <- function(powerList, savePlot=FALSE) {
  #determine dataType
